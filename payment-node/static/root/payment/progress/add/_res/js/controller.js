var app = angular.module('progressAdd', ['toastr']);
app.controller('progressAddCtrl', function ($scope, progressSer, $state, toastr,$http,$stateParams) {
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/progImport/templateExport');
    };
    //删除文件
