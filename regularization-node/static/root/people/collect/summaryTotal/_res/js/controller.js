var app = angular.module('collectTotal', ['toastr']);
app.controller('collectTotalCtrl', function($scope, collectSer,toastr){
    $scope.showed=true;
    $scope.collect = function(){
        ...
        collectSer.collectTotal(data.sum).then(function(response){
