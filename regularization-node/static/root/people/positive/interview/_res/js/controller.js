var app = angular.module('positInterview', ['toastr']);
app.controller('positInterviewCtrl', function($scope, positSer,$stateParams,$state,toastr){
    ...
    $scope.webEditFun = function(){
        var vm = $scope;
        positSer.positInterview(vm.data).then(function(response){
            if(response.data.code == 0){
